...
* **Service certification**：Based on the oauth2 framework, it supports four authorization modes, which are divided into auth-server and auth-client, which satisfy the function while making the code as concise as possible..
